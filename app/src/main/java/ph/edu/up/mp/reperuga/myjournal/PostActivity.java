...
public class PostActivity extends AppCompatActivity {
    ...
    private void startPosting() {
        ...
        mProgress.setMessage("Posting to Journal ...");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_view_profile) {
            ...
            startActivity(new Intent(PostActivity.this, ViewProfileActivity.class));
        ...
        if(item.getItemId() == R.id.action_settings) {
            ...
            startActivity(new Intent(PostActivity.this, AccountSettingsActivity.class));
